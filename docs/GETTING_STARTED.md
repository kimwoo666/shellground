...
- **Windows 10/11 x64:** download the [Windows compatibility update](https://github.com/kimwoo666/shellground/releases/download/v4.7.4-windows.2/Shellground-Windows-Setup.exe), double-click `Shellground-Windows-Setup.exe`, install, then use the **Shellground** Start-menu or desktop shortcut.
