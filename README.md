...
[Downloads](https://github.com/kimwoo666/shellground/releases) · [Getting started](docs/GETTING_STARTED.md) · [Platform & verification notes](docs/PLATFORMS.md)
...
| Android | [Android.apk](https://github.com/kimwoo666/shellground/releases/download/v4.7.7-android/Shellground-4.7.7-Android.apk) | 4.7.7: course navigation, completion indicators and Linux startup improvements. [Details](docs/ANDROID_4.7.7.md). **Physical ARM phones unverified** |
