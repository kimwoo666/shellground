...
!define APPDIR "app-4.7.4-windows.3"
...
Section "Shellground" Main
  ...
  WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\Shellground" "DisplayVersion" "4.7.4-windows.3"
