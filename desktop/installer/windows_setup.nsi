...
Section "Shellground" Main
  ...
  !ifdef APP_ARCHIVE
    SetCompress off
    File /oname=application.zip "${APP_ARCHIVE}"
    SetCompress auto
  !endif
  ...
  WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\Shellground" "DisplayVersion" "4.7.6"
